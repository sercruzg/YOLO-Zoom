...
void hardmax_gpu(float *input, int n, int offset, int groups, float temp, float *output);
void adam_gpu(int n, float *x, float *m, float *v, float B1, float B2, float rate, float eps, int t);

void flatten_ongpu(float *x, int spatial, int layers, int batch, int forward, float *out);
void flatten2col_ongpu(float *im, int channels, int height, int width, int classes, float *data_col, int forward);
void im2elemcol_ongpu(float *data_im, int channels, int height, int width, int ksize, int pad, float *data_col);
void elemcol2im_ongpu(float *data_col, int channels, int height, int width, int ksize, float *data_im);
void im2max_ongpu(float *in_im, int * indexes, float * flat, int height, int width, int channels, int batch, int ksize, int pad, float *out_im);
void im2max_back_ongpu(float *in_im, int * indexes, int height, int width, int channels, int batch, int ksize, int pad, float *out_im);
//mvoid im2flat_ongpu(float *in_im, int height, int width, int channels, int batch, int ksize, int pad, float *out_im);
void flat2im_ongpu(float *in_im, int height, int width, int channels, int batch, int ksize, int pad, float *out_im);
